...
class AnalysisTestsHelper {
    ...
    static ESTestCase.TestAnalysis createTestAnalysis(
            Settings settings, AnalysisPlugin plugin) throws IOException {
        ...
        AnalysisRegistry analysisRegistry = new AnalysisModule(new Environment(settings), singletonList(plugin))
                .getAnalysisRegistry();
