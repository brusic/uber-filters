...
public class DatabaseFixture {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("Starting DatabaseFixture with args " + Arrays.asList(args));
        System.out.println("Startup " + new java.util.Date());

        if (args.length != 1) {
            throw new IllegalArgumentException("DatabaseFixture <logDirectory>");
        }
